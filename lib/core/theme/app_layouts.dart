...
class ButtonStyles { 
  static final elevatedbutton1 = ElevatedButton.styleFrom( //boton 1 
    backgroundColor: AppColors.primary,
    padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
    textStyle: TextStyle(color: AppColors.tertiary),
    minimumSize: Size(100, 40), //tamaño minimo
    shape: RoundedRectangleBorder(borderRadius: BorderRadiusGeometry.circular(12)) //borde
  );

   static final elevatedbutton2 = ElevatedButton.styleFrom( //boton 2
