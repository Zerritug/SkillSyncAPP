  ...
  flexibleSpace: Container(
    decoration: BoxDecoration(
      gradient: LinearGradient(
        ...
        colors: AppColors.appbargradient, //usa lista de colores en app colors.
      ),
    ),
  ),
  title: Padding(
    ...
    child: Column(
      ...
      children: [
        Text('¡Hola, $userName', style: AppTextStyles.greeting),//estilo de texto
        Text('Nivel de usuario: $level', style: AppTextStyles.userlevel), //estilo de texto
      ],
    ),
  ),
),
        ...
        Row(
          ...
          children: [
            ElevatedButton(
              ...
              child: const Text('Estadísticas', style: AppTextStyles.button1),
            ),
        ...
        Row(
          ...
          children: [
            ElevatedButton(
              ...
              style: ButtonStyles.elevatedbutton1,
              child: const Text('Añadir Lecciones', style: AppTextStyles.button1),
            ),
            const SizedBox(width: 40),
            ElevatedButton(
              onPressed: () {
              ...
              style: ButtonStyles.elevatedbutton1,
              child: const Text('Añadir Tema', style: AppTextStyles.button1),
            ),
          ],
        ),
        ...
        Row(
          ...
          children: [
            ElevatedButton(
              ...
              child: const Text('Ver Lecciones', style: AppTextStyles.button2),
            ),
            const SizedBox(width: 40),
            ElevatedButton(
              onPressed: () {
              ...
              style: ButtonStyles.elevatedbutton2,
              child: const Text('Ver Temas', style: AppTextStyles.button2),
            ),
          ],
        ),
